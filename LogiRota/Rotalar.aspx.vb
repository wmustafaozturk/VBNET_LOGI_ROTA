...
Public Class Rotalar
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
    End Sub
    Public Sub ROTA_GRIDLE()
        Dim cn1 As New SqlConnection
        cn1.ConnectionString = WebConfigurationManager.ConnectionStrings("Con").ToString()
        Dim CMD As New SqlCommand("SELECT * FROM LOGI_DATA.DBO.ROTALAR ORDER BY ROTA_KOD ASC", cn1)
    ...
    End Sub
    Private Sub BTN_ROTA_ARA_Click(sender As Object, e As EventArgs) Handles BTN_ROTA_ARA.Click
        Dim cn1 As New SqlConnection
        cn1.ConnectionString = WebConfigurationManager.ConnectionStrings("Con").ToString()
        Dim CMD As New SqlCommand("SELECT * FROM LOGI_DATA.DBO.ROTALAR where ROTA_ADI like '%" + TXT_ARA.Text + "%'", cn1)
        CMD.CommandType = CommandType.Text
        Dim DA As New SqlDataAdapter(CMD)
        Dim DT As New DataTable
        DA.Fill(DT)
