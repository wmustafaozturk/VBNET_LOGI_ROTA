<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Depolar.aspx.vb" Inherits="LogiRota.Depolar" %>
...
<body>
    <form id="form1" runat="server" defaultbutton="BTN_DEPO_ARA">
   ...
   <div class="container">
    ...
    <ContentTemplate>	
			...
			<ul id="gn-menu" class="gn-menu-main">
                ...
                <li><asp:Button ID="BTN_DEPO_ARA" runat="server" CssClass=" BtnAra"  ToolTip="Rota Ara"  /></li>	
               ...
               <li><span>USD </span><asp:TextBox ID="TXT_USD" runat="server"></asp:TextBox></li>
                ...
                <li><a class="codrops-icon codrops-icon-drop">MENU - DEPOLAR</a></li>
...
<div id="FIYAT_LISTELERI_DIV" class="grid" runat="server"  >
                 ...
                 <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DEPO_ID" HeaderText="ID"   HeaderStyle-BackColor="#ff8000"/>                        
                        <asp:TemplateField  HeaderText ="DEPO ADI" HeaderStyle-BackColor="#ff8000"><ItemTemplate><asp:TextBox ID="txtDEPO_ADI"  Width="250px" runat="server" Text='<%# Bind("DEPO_ADI")%>' ></asp:TextBox></ItemTemplate></asp:TemplateField>
                        <asp:TemplateField  HeaderText ="DEPO ADRESI" HeaderStyle-BackColor="#ff8000"><ItemTemplate><asp:TextBox ID="txtDEPO_ADRESI" Width="350px"   runat="server" Text='<%# Bind("DEPO_ADRESI")%>' ></asp:TextBox></ItemTemplate></asp:TemplateField>                        
                       <asp:TemplateField  HeaderText ="GOOGLE_KOORDINAT_x" HeaderStyle-BackColor="#ff8000"><ItemTemplate><asp:TextBox ID="txtGOOGLE_KOORDINAT_x" runat="server" Text='<%# Bind("GOOGLE_KOORDINAT_x")%>'></asp:TextBox></ItemTemplate></asp:TemplateField>                         
                        <asp:TemplateField  HeaderText ="GOOGLE_KOORDINAT_y" HeaderStyle-BackColor="#ff8000"><ItemTemplate><asp:TextBox ID="txtGOOGLE_KOORDINAT_y"  runat="server" Text='<%# Bind("GOOGLE_KOORDINAT_y")%>' ></asp:TextBox></ItemTemplate></asp:TemplateField> 
